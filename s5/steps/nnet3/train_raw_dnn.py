...
def get_args():
    ...
    parser.add_argument("--trainer.input-model", type=str,
                        ...
                        model.""")
    parser.add_argument("--trainer.var-file", type=str,
                        dest='var_file', default=None,
                        help="""If specified, the left and right context will be
                             read from""")
