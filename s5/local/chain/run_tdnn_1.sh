...
affix=2i   #affix for TDNN+LSTM directory e.g. "1a" or "1b", in case we change the configuration.
common_egs_dir=
reporting_email=
...
if [ $stage -le 15 ]; then
  ...
  relu-renorm-layer name=prefinal-chain dim=1024 target-rms=0.5
  ...
  relu-renorm-layer name=prefinal-xent input=tdnn6 dim=1024 target-rms=0.5
