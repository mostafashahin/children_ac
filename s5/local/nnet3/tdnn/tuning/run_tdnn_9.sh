...
dir=exp/nnet3_tdnn/tdnn_9
dir=$dir${affix:+_$affix}
dir=${dir}$suffix
train_set=train
ali_dir=exp/tri3_ali_train_sp/
tree_dir=exp/chain_lfr/tree_a_sp
lang=data/lang_chain_lfr
graph=exp/chain_lfr/tree_a_sp/graph_test4gr
