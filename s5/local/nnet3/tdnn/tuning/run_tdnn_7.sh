...
if [ $stage -le 9 ]; then
  ...
  relu-renorm-layer name=tdnn2 input=Append(-1,1) dim=1024
  relu-renorm-layer name=tdnn3 input=Append(-1,1) dim=1024
  relu-renorm-layer name=tdnn4 input=Append(-2,2) dim=1024
  relu-renorm-layer name=tdnn5 input=Append(-2,2) dim=1024
  relu-renorm-layer name=tdnn6 input=Append(-2,2) dim=1024
  relu-renorm-layer name=tdnn7 input=Append(-4,4) dim=1024
  relu-renorm-layer name=tdnn8 dim=1024
