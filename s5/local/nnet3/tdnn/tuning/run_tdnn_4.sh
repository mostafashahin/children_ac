...
if [ $stage -le 9 ]; then
  ...
  relu-renorm-layer name=tdnn2 input=Append(-1,0,1) dim=650
  relu-renorm-layer name=tdnn3 input=Append(-1,0,1) dim=650
  relu-renorm-layer name=tdnn4 input=Append(-3,0,3) dim=650
  relu-renorm-layer name=tdnn5 input=Append(-6,-3,0) dim=650
