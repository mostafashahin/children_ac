...
if [ $stage -le 9 ]; then
  ...
  relu-renorm-layer name=tdnn2 input=Append(-1,2) dim=750
  relu-renorm-layer name=tdnn3 input=Append(-3,3) dim=750
  relu-renorm-layer name=tdnn4 input=Append(-7,2) dim=750
  relu-renorm-layer name=tdnn5 input=Append(-3,3) dim=750
